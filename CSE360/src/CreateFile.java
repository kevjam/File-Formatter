...
public class CreateFile {
	...
	// Added a parameter for spacing to determine if it will add one or two %n's at
	// the end of a line
	public void writeToFile(String line, boolean newline, String justified, String spacing, int linelength) {
		if (justified.equals("right")) {
			...
			// Connor: Calvin, his is where you will likely add your new function call for
			// writeFullJustified
	...
	public void writeFullJustified(String line, boolean newline, String spacing, int linelength) {
		...
		// Only modify line if difference is greater than 0. A negative value indicates
		// that it's just one
		// Big word, and a zero value indicates that we're fine
		if (newline && difference > 0) {
